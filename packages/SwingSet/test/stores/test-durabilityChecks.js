...
const virtualHolderMaker = makeKind(makeHolderInstance);
const durableHolderMaker = makeDurableKind(makeHolderInstance);

const aString = 'zorch!';
const aVirtualObject = virtualHolderMaker();
const aDurableObject = durableHolderMaker();
