...
function validateCreateStore(v, idx) {
...
function validateDeleteMetadata(
  ...
  validateDeleteMetadataOnly(v, idx, contentRef, contentType, rc, nonVirtual);
}
...
test.serial('store refcount management 1', async t => {
  ...
  validateDeleteMetadata(v, NONE, 2);
  validateDone(v);
});
...
test.serial('store refcount management 2', async t => {
  ...
  validateDeleteMetadata(v, NONE, 3, mapRef(2), 'mapStore', 3);

  validateRefCountCheck(v, mapRef(4), NONE);
  validateDeleteMetadata(v, NONE, 4, mapRef(2), 'mapStore', 2);

  validateRefCountCheck(v, mapRef(5), NONE);
  validateDeleteMetadata(v, NONE, 5, mapRef(2), 'mapStore', 1);

  validateRefCountCheck(v, mapRef(2), '0', NONE);
  validateDeleteMetadata(v, NONE, 2, NONE, NONE, 1);
...
test.serial('store refcount management 3', async t => {
  ...
  validateReturned(v, rp);
  validateRefCountCheck(v, mapRef(5), NONE);
  validateDeleteMetadata(v, NONE, 5, mapRef(4), 'mapStore', 1);
  validateRefCountCheck(v, mapRef(4), '0');
  validateDeleteMetadata(v, NONE, 4, mapRef(3), 'mapStore', 1);
  validateRefCountCheck(v, mapRef(3), '0');
  validateDeleteMetadata(v, NONE, 3, mapRef(2), 'mapStore', 1);
  validateRefCountCheck(v, mapRef(2), '0');
  validateDeleteMetadata(v, NONE, 2, NONE, NONE, 1);
  validateDone(v);
});
...
test.serial('presence refcount management 2', async t => {
  ...
  validateReturned(v, rp);
  validateRefCountCheck(v, mapRef(2), NONE);
  validateDeleteMetadata(v, NONE, 2, 'o-5', 'thing', 3);
  validateRefCountCheck(v, mapRef(3), NONE);
  validateDeleteMetadata(v, NONE, 3, 'o-5', 'thing', 2);
  validateRefCountCheck(v, mapRef(4), NONE);
  validateDeleteMetadata(v, NONE, 4, 'o-5', 'thing', 1);
...
test.serial('remotable refcount management 2', async t => {
  ...
  validateReturned(v, rp);
  validateRefCountCheck(v, mapRef(2), NONE);
  validateDeleteMetadata(v, NONE, 2, 'o+9', 'thing', 3, true);
  validateRefCountCheck(v, mapRef(3), NONE);
  validateDeleteMetadata(v, NONE, 3, 'o+9', 'thing', 2, true);
  validateRefCountCheck(v, mapRef(4), NONE);
  validateDeleteMetadata(v, NONE, 4, 'o+9', 'thing', 1, true);
  validateDone(v);
});
...
test.serial('verify store weak key GC', async t => {
  ...
  validateInit(v);
  validateCreateStore(v, 2); // map
  validateCreateStore(v, 3); // set
  ...
  validateDeleteMetadataOnly(v, 4, NONE, NONE, 47, false);
  validate(v, matchVatstoreGet(`vc.2.|${mapRef(4)}`, '1'));
